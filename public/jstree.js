				...
				.on('keydown.jstree', '.jstree-anchor', $.proxy(function (e) {
						...
						switch(e.which) {
							case 32: // aria defines space only with Ctrl
								...
								break;
							case 13: // enter
								if(this.is_selected(e.currentTarget)) {
									// create sibling node at pos
									// alert('ready to create sibling node');
									// TODO:
									var selected = this.get_node(e.currentTarget);
									var parent = this.get_node(this.get_parent(selected));
									var selectedId = selected.id;
									var selectedPos = parent.children.indexOf(selectedId);
									this.create_node (parent, 'new Node', selectedPos + 1, function() {
										var newNode = this.get_node(this.get_next_dom(selected));
										this.edit(newNode);
									});
									// create_node (o, 'new Node'
									break;
								}
								e.type = "click";
								$(e.currentTarget).trigger(e);
							...
							case 45:
								...
								var context = this;
								this.open_node(e.currentTarget, function (o2) { this.get_node(o2, true).children('.jstree-anchor').focus(); });
								if(o && o.id) {
										...
										context.create_node (o, 'new Node', 'last', function() {
										console.log('new node created:');
										console.dir(newNode);
										var newNode = o.children[o.children.length - 1];
										// open node with new child, now openable
										this.open_node(e.currentTarget, function (o2) { this.get_node(o2, true).children('.jstree-anchor').focus();
										context.edit(newNode);
										});
							...
							case 112:
								...
								o = this.get_node(e.currentTarget);
								if(o && o.id ) {
									console.log('###output F1: selected Node: ###');
									console.dir(o);
								}
								break;
							default:
